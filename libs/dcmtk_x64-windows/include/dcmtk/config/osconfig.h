...
#define DCMTK_PREFIX "" /* redacted by vcpkg */

/* Define the default data dictionary path for the dcmdata library package */
#define DCM_DICT_DEFAULT_PATH "" /* redacted by vcpkg */
...
#define DEFAULT_CONFIGURATION_DIR "" /* redacted by vcpkg */

/* Define to the default support data directory (used by some applications) */
#define DEFAULT_SUPPORT_DATA_DIR "" /* redacted by vcpkg */
